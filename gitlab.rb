...
external_url 'https://gitlab2.tymchenko.local'
...
gitlab_rails['smtp_user_name'] = "tymc4enkogitlab@gmail.com"
gitlab_rails['smtp_password'] = "rapmary123"
...
gitlab_rails['ldap_servers'] = {
  'main' => {
    'label' => 'LDAP',
    'host' =>  'ipa.tymchenko.local',
    'port' => 636,
    'uid' => 'uid',
    'bind_dn' =>  'uid=gitlabadmin,cn=users,cn=accounts,dc=tymchenko,dc=local',
    ...
    'base' => 'dc=tymchenko,dc=local',
    'user_filter' => '(&(objectclass=person)(memberOf=cn=enroll_computers,cn=groups,cn=accounts,dc=tymchenko,dc=local))',
    'attributes' => {
      'username' => ['uid'],
      'email' => ['Email'],
      'name' => 'ui',
...
# user_filter: '(&(objectClass=user)(memberOf=CN=enroll_computers,CN=groups,CN=accounts,DC=tymchenko,DC=local))'
#  attributes:
 #   username: ['uid']
  #  email: ['mail']
#    name: 'displayName'
...
#  port: 636
#  uid: 'uid'
#  bind_dn: 'uid=gitlabadmin,cn=enroll_computers,cn=groups,cn=accounts,dc=tymchenko,dc=local'
...
#    ca_file: '/etc/ipa/ca.crt'
 ...
 # block_auto_created_users: false
#  base: 'dc=tymchenko,dc=local'
#  user_filter: '(memberOf=cn=enroll_computers,cn=groups,cn=accounts,dc=tymchenko,dc=local)'
#
#EOS
...
####!   is created and seeded won't yield any change.**
 gitlab_rails['initial_root_password'] = "rapmary123"
...
registry_external_url 'https://gitlab2.tymchenko.local:5050'

### Settings used by GitLab application
gitlab_rails['registry_enabled'] = true
registry_nginx['ssl_certificate'] = "/etc/gitlab/ssl/httpd.pem"
registry_nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/httpd.key"
registry['enable'] = true
gitlab_rails['registry_host'] = "gitlab2.tymchenko.local"
...
# nginx['ssl_verify_depth'] = "1"
 ...
 nginx['ssl_certificate'] = "/etc/gitlab/ssl/httpd.pem"
 nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/httpd.key"
...
gitlab_rails['gitlab_kas_external_url'] = 'wss://gitlab2.tymchenko.local/-/kubernetes-agent/'
